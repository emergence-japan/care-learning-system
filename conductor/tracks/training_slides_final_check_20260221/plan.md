...
- [ ] Task: 14_prevention.ts の内容差し替え（身体拘束→介護予防）
    - [ ] 「法定研修16項目テキスト.pdf」から「介護予防及び要介護進行予防」のテキストを抽出
    - [ ] `14_prevention.ts` を新規コンテンツ（スライド＋テスト）で上書き実装
- [ ] Task: Conductor - User Manual Verification 'Phase 1' (Protocol in workflow.md)

## フェーズ 2: 全15科目の順次検証と修正（セクションA: 権利擁護・安全管理系）
...
- [ ] Task: 14_prevention.ts（介護予防・要介護進行予防）の最終確認と修正
- [ ] Task: Conductor - User Manual Verification 'Phase 2' (Protocol in workflow.md)

## フェーズ 3: 全15科目の順次検証と修正（セクションB: 倫理・プライバシー・運営管理系）
...
- [ ] Task: 13_mental.ts（精神的ケア）の最終確認と修正
