...
- [~] Task: 検証用マスターチェックリストの更新
    - [ ] ID（フック、事例、整合性）とデザイン（HTML構造、レスポンシブ）の2軸で作成
- [x] Task: 14_prevention.ts の「介護予防」への差し替え（マスター準拠） [f781ac6]
    - [x] マスターのHTML構造をベースに、介護予防のテキストを流し込み、事例とテストを構築
- [ ] Task: Conductor - User Manual Verification 'Phase 1' (Protocol in workflow.md) [checkpoint: f781ac6]
