    ...
    data: {
      ...
      introduction: `
        <div class="space-y-8">
          ...
          <h2 class="text-4xl font-black text-slate-900 leading-tight">パニックを、<br/>「技術」で制する。</h2>
      ...
      slides: {
        create: [
          ...
          { title: '救命の鎖：胸骨圧迫とAED', order: 2, content: `<div class="space-y-6"><div class="bg-slate-900 text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden text-center"><h4 class="text-2xl font-black mb-6">絶え間ない圧迫が脳を守る</h4><div class="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left"><div class="p-4 bg-white/5 border border-white/10 rounded-2xl"><p class="text-emerald-400 font-black text-xs mb-2">胸骨圧迫</p><p class="text-xs leading-relaxed">・「強く、速く、絶え間なく」<br/>・1分間に100〜120回のリズム<br/>・5cm以上沈むまで押す</p></div><div class="p-4 bg-white/5 border border-white/10 rounded-2xl"><p class="text-emerald-400 font-black text-xs mb-2">AEDの役割</p><p class="text-xs leading-relaxed">・電源を入れれば音声が誘導<br/>・心室細動をリセットする唯一の手段<br/>・電気ショック後すぐ圧迫再開</p></div></div></div></div>` },
