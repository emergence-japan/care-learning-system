    ...
    data: {
      ...
      slides: {
        create: [
          ...
          { title: '福祉用具の安全点検：ベッド・サイドレール', order: 4, content: `<div class="p-10 bg-amber-50 rounded-[3rem] border border-amber-100 flex flex-col items-center text-center space-y-6"><h4 class="text-2xl font-black text-amber-900">「隙間」が命を奪う</h4><p class="text-slate-600 text-sm font-medium leading-relaxed">ベッド柵の隙間や、柵とマットレスの間に首や手足が挟まる事故が多発しています。**JIS規格（T9254）適合品**を使用しているか、柵にガタつきがないか、毎日の確認が必須です。特に夜間の安否確認時に隙間をチェックしてください。</p></div>` },
