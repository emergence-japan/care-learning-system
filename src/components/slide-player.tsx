    ...
    <div className="h-full w-full flex flex-col items-center justify-start space-y-2 lg:space-y-4 bg-slate-50">
      ...
      <div className="flex-1 min-h-0 w-full flex flex-col lg:flex-row items-center justify-center gap-3 lg:gap-8">
        ...
        {activeTab === "slide" && (
          <>
            {/* Slide Container */}
            <div className="w-full lg:max-w-5xl lg:aspect-video lg:bg-white lg:border lg:border-slate-200 lg:rounded-[2.5rem] flex flex-col overflow-y-auto lg:overflow-hidden lg:shadow-2xl relative order-1 lg:order-2">
