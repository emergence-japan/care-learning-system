...
export default async function AdminDashboardPage() {
  ...
  if (!facility) return <div className="p-20 text-center font-bold text-red-500">施設情報が見つかりません。</div>;
  ...
  const totalExpected = totalStaff * assignments.length;
  const globalProgress = totalExpected > 0 ? Math.round((totalCompletedEnrollments / totalExpected) * 100) : 0;
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-12">
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            ...
            <div id="annual-plan" className="space-y-6">
              ...
              <Card className="border border-slate-200 bg-white rounded-[2rem] p-4 lg:p-10 shadow-sm min-h-[200px] flex items-center justify-center">
                {assignments.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-slate-300 text-xs mt-2">「研修を割り当てる」ボタンから、本年度の計画を設定しましょう。</p>
                  </div>
                )}
              </Card>
            </div>
